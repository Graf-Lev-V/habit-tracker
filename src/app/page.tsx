...
export default function Home() {
  return (
      <main className="min-h-screen flex flex-col justify-center items-center gap-4 px-4">
        <h1 className="text-4xl">Habit Tracker</h1>
        <p className="text-white/75 text-center">Track your habits, build streaks, and stay consistent — one day at a time.</p>
