    ...
    return (
        ...
        <main className='p-4 flex flex-col items-center gap-4 '>
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-5 '>
                <div className='h-[96px] sm:h-[120px] px-8 py-3 sm:py-6 rounded flex flex-col gap-3 bg-neutral-700 shadow-lg animate-pulse items-center'>
            ...
            <div className="flex flex-col gap-4 justify-center items-center w-full max-w-[450px] sm:max-w-6xl">
                <div className='rounded p-4 bg-neutral-800 flex flex-col shadow-lg animate-pulse w-full'>
                    ...
                    <div className="border-t border-white/10 pt-3 mt-1 flex flex-col items-center">
                        ...
                        <div className="block sm:hidden w-full bg-neutral-700 rounded animate-pulse" style={{aspectRatio: '14 / 7'}}></div>
                    </div>
                </div>
                <div className='rounded p-4 bg-neutral-800 flex flex-col shadow-lg animate-pulse w-full'>
                    <div className="h-8 flex justify-between items-center gap-2 mb-1">
