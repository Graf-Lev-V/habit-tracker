...
export default function AddHabitForm() {
    ...
    return (
        <div className="flex flex-col gap-4 items-center">
            <button className="w-12 h-12 border border-white/25 bg-neutral-800 hover:bg-neutral-900 transition-colors rounded text-xl shadow-lg" onClick={() => setFormState(!formState)}>+</button>
            {formState &&
