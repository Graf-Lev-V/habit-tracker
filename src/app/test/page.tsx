...
export default function Test() {
    return (
        ...
        <main className='p-4 flex flex-col items-center gap-4 '>
            ...
            <div className="flex flex-col gap-4 justify-center items-center min-w-0 w-max">
                <div className='sm:w-full sm:max-w-6xl rounded p-4 bg-neutral-800 flex flex-col shadow-lg animate-pulse'>
                    ...
                    <div className="border-t border-white/10 pt-3 mt-1 flex flex-col items-center">
                        ...
                        <div className="block sm:hidden bg-neutral-700 rounded animate-pulse" style={{width: "min(422px, calc(100vw - 2rem))", aspectRatio: '14 / 7'}}></div>
                    </div>
                </div>
                <div className='sm:w-full sm:max-w-6xl rounded p-4 bg-neutral-800 flex flex-col shadow-lg animate-pulse'>
                    <div className="h-8 flex justify-between items-center gap-2 mb-1">
